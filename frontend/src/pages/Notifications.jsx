...
const fetchNotifications=async ()=>{
  ...
  return (
    <div className='w-full h-[100vh] bg-[#e0e5ec] overflow-auto pb-[100px] animate-explode origin-center'>
       <div className='w-full h-[80px]  flex items-center gap-[20px] px-[20px] lg:hidden'>
                      ...
                      <h1 className='text-[#2d3748] text-[20px] font-semibold'>Notifications</h1>
                  </div>
