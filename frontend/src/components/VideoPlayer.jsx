...
useEffect(()=>{
  ...
  return (
    <div className='h-[100%] relative cursor-pointer max-w-full rounded-5xl overflow-hidden'>
      <video ref={videoTag} src={media} autoPlay loop muted={mute} className='h-[100%] cursor-pointer w-full object-cover rounded-5xl' onClick={handleClick}/>
