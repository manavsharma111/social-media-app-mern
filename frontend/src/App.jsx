...
export const serverUrl = import.meta.env.VITE_BACKEND_URL || (window.location.hostname === 'localhost' ? "http://localhost:8000" : "https://social-media-app-mern-iota.vercel.app");
function App() {
   getCurrentUser()
   getSuggestedUsers()
   getAllPost()
